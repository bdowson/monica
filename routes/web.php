...
Route::middleware(['auth', 'verified', 'u2f', '2fa'])->group(function () {
    ...
    Route::name('settings.')->group(function () {
        ...
        Route::name('admin.')->middleware(['is_admin'])->group(function () {
            ...
            Route::get('/settings/admin/account-id', 'Settings\\AdminController@getAccountId');
            Route::post('/settings/admin/create-new-account', 'Settings\\AdminController@createNewAccount');
        });
